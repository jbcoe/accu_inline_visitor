...
At this juncture it should be clear that we require a method for defining functions external to the derived class definitions. Before turning to the visitor pattern, we consider the pros and cons of real-time type identification (RTTI), which accomplishes precisely this.

\begin{section}{Real-time type identification}

\textit{to do}

\begin{section}{The visitor pattern}

\textit{to do}

\begin{section}{The inline visitor pattern}
